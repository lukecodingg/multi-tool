...
def username_profiler():
    print("\033[92m\n[ USERNAME PROFILER ]\033[0m")
    ...
    platforms = {
        ...
        "Threads": f"https://threads.com/@{username}",
    ...
    for platform, url in platforms.items():
        try:
            ...
            if response.status_code == 200:
                print(f"\033[92m[+] {platform}: Exists ➜ {url}\033[0m")
            elif response.status_code == 404:
                print(f"\033[91m[-] {platform}: Not Found\033[0m")
            else:
                print(f"\033[93m[?] {platform}: Unknown (Status {response.status_code})\033[0m")
        except Exception as e:
            print(f"\033[91m[!] {platform}: Error ({e})\033[0m")


system(f'title Lukecodingg multitool')
print(f'''
{Fore.RED}
▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
▐                                         Lukecodingg Multi Tool                                                                                      ▐ 
▐                                         ------------------------                                                                                    ▐ 
▐ 1 = Card Gen              2 = Email Gen          3 = Ip Pinger         4 = Ip Analyzer         5 = Phone Gen        6 = Discord Spammer             ▐ 
▐  7 = Nitro Gen            8 = Base64 Encoder     9 = Base64 Decoder    10 = Webhook Spammer    11 = Morpheus        12 = Combo Gen                  ▐ 
▐ 13 = Domain Check         14 = Email Check       15 = FakeHack         16 = Sms Sender         17 = Proxy Gen       18 = Discord Token Checker      ▐ 
▐ 19 = Username profiler    20 = Get wifi pass     21 = Email spam       22 = DDOS               23 = W yt                                            ▐                     
▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀                                                                                                                           
{Style.RESET_ALL}
''')
...
if menu3 == '1':
    ...
    with open(f"Cards{num}.txt", "w", encoding='utf-8') as filebb:
        ...
        for i in range(loopamm):
            ...
            print(
                f'{Fore.GREEN}{Style.BRIGHT}({i}) - {part1}{part2}-{part3}-{part4}-{part5} {part7}/{part8} {part6}{Style.RESET_ALL}')
    ...
    with open(f"Emails{baiduj}.txt", "w", encoding='utf-8') as fileffs:
        jdjdjd = (
        ['justin', 'james', 'juan', 'lopez', 'matt', 'bryan', 'tina', 'mark', 'mason', 'brass', 'jeff', 'caleb',
    ...
    phone = input(f"{Fore.LIGHTBLUE_EX}[?] How Many Numbers To Generate : ")
    ...
    with open(f"PhoneNums{phonee2}.txt", "w", encoding='utf-8') as ggas:
        for i in range(phonee2):
            kyyee = random.choice(['8a9b286db37242278c650f057e69af0a', 'c18e40093aa54050869e6c025cd212ad',
                                   'ce7e22fa1b664e30b7479c2fae835b6e', '65fb967dd10d4dfdae57aac38359b784',
                                   '4ef2dc40a978468fa34d3148fa5edea2', '57e32fc3db4a43f8bb1a8789530e47e2',
                                   '7dca8166ab2c4dac8fe6f92b4cbd6d07', 'fcdad5e099284c5b8e87a92a1ea799b8',
                                   'a73831d44e694faaac2f2700cf477200', '7da18e005724444fbc5c663b5f936bae',
                                   '39d2d11cc1dc4e43a0f6d2851365fc74', '1040025afab84d3fb0a54b03dc05e973',
                                   'e366c837dfff41b6a929ea9c5dc39f39', 'e1cbb145d55c47beb794d53e0ecfd0e5',
                                   '9349b70a50f94a08b33622c794f0133b', '2baaaa8e8eab4a08aeea4fad3c5022eb',
                                   '7c1e7070816f40a68f43c96a098e6247', '82e2b664b70844beb297ade47f46bdf0'])
            ...
            if response.status_code == 200:
                ...
                print(f"{Fore.RED}{Style.BRIGHT}[!] 404 KIDDO THIS API KEY GOT FCKED WAIT 1 MONTH{Style.RESET_ALL}")
elif menu3 == '6':
    token = input(f"{Fore.LIGHTBLUE_EX}[?] Enter Discord Token : ")
    print(f'Using {token}')
    bot = commands.Bot(command_prefix='!')

    aaa3894 = input(f"{Fore.LIGHTBLUE_EX}[?]How Many Times Do Want To Spam : ")
    message = input(f"{Fore.LIGHTBLUE_EX}[?] What Message Do You Want To Spam : ")
    G4dah4 = int(aaa3894)
    time.sleep(1)
    ...
    async def on_message(message):
        if message.content.startswith('!spam'):
            for i in range(G4dah4):
                await message.channel.send(f"({i}) {message}")


    bot.run(f"{token}", bot=False)
elif menu3 == '7':
    print(f"{Fore.RED}Due To The Chances Of Getting A Real Code We Dont Have A Checker Sorry")
    time.sleep(1)
    ...
    with open(f"NitroCodes{AMMOun4t}.txt", "w", encoding='utf-8') as fileffs:
        ...
        for i in range(G4dah4ss):
            cood43 = "".join(
                random.choice("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890") for _ in range(16))
    ...
    if jamiee == "y":
        for i in range(ballsxd):
            ...
            if res.status_code == 200:
                ...
                data = requests.post(webhookurl, json={"content": str(sexxdded), "name": str(sdashdd),
                                                         "avatar_url": "https://cdn.discordapp.com/attachments/933540730083872889/935019209652596736/01d8Ghah.jpg"})
                print(f"{i} {Fore.GREEN} Message Sent")
    elif jamiee == "n":
        for i in range(ballsxd):
            data = requests.post(webhookurl, json={"content": str(messah48), "name": str(sdashdd),
                                                     "avatar_url": "https://cdn.discordapp.com/attachments/933540730083872889/935019209652596736/01d8Ghah.jpg"})
            print(f"{i} {Fore.GREEN} Message Sent")
elif menu3 == '11':
    jk = "999999999999999999999999"
    jameeisxz = int(jk)
    for i in range(jameeisxz):
        fakehackermsg = random.choice(['Decrypting Firewall', 'Anlyzing ByteCode', 'Exploting Weakness',
                                       'Attempting to brute force admin password', '<HTTP HEADERS>',
                                       'PACKAGE=JSON.FILE'])
    ...
    whooo = "@yahoo.com"
    combos = input(f"{Fore.LIGHTCYAN_EX}[?] How Many Combos Do You Want To Make : ")
    nummiesss = int(combos)
    maof = (['cooper', 'feet', 'gaminqs', 'ricebb', 'mattie', 'homies', 'fortnite', 'email', 'main', 'bikes', 'Douglas',
             'Zachary', 'Peter', 'Kyle', 'george', 'shroud', 'reactor', 'Walter', 'Ethan', 'Jeremy', 'Harold', 'Keith',
             'Beast', 'Baloon', 'rich', 'roddy', 'apple', 'bear', 'hecktor', 'pines', 'schools', 'mapping', 'awesome',
             'bird', 'purple', 'magical', 'gaming', 'trappa', 'monster', 'creative', 'youtube', 'OMFG', 'spire', 'chip',
             'Jailed', 'tick', 'mathew', 'Micc', 'house', 'Fighter', 'jet', 'santos', 'crypto', 'kitten', 'rapper',
             'Swan'])
    with open(f"Combos{combos}.txt", "w", encoding='utf-8') as fileffs:
        for i in range(nummiesss):
            ...
            cood43 = "".join(
                random.choice("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890") for _ in range(gamer3))
            cood433 = "".join(
                random.choice("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890") for _ in range(gamer2))
            cood4333 = "".join(
                random.choice("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890") for _ in range(gamer21))
    ...
    key = random.choice(
        ['FTFGFJi5QBMmcCn2yogGDXwye72NVVZY', 'KVPwoPgSR3HO8hrjnoHGv28AYAEFp7fI', 'QB3zT99JD1On6XBpPKU3EBntnNhT1kZ8'])
    ...
    for i in range(balls):
        ...
        responcealt = random.choice(
            ['Packet Error', 'Host Not Responding', f'Frame Error ID : {gamer2212}', 'CloudFlare Error 400'])
        responce = random.choice(['Invalid Login', f'Internal Error == {responcealt}'])
        gamer221 = random.randint(5, 50)
        cood4333 = "".join(
            random.choice("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890") for _ in range(gamer221))
        time.sleep(.05)
    ...
    if question1 == 'n':
        ...
        jamesad = int(huo)
        print('Getting Proxys From Different Apis')
        egg = requests.get(
        ...
        for i in range(jamesad):
            keys = random.choice(['https://public.freeproxyapi.com/api/Proxy/Mini', 'http://pubproxy.com/api/proxy',
...
if menu3 == '19':
    username_profiler()
if menu3 == '20':
 subprocess.run(["files/wifipass.bat"], shell=True)
if menu3 == '21':
 subprocess.call(["python", "files/emailspam.py"])
if menu3 == '22':
 subprocess.call(["python", "files/DDOS.py"])
if menu3 == '23':
    webbrowser.open("https://www.youtube.com/@ebolaman_")
